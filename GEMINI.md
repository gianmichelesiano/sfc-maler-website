...
Preset E — "Craft Signal" (Artigianato Professionale)
Identità: Un'impresa artigiana svizzera che bilancia calore umano e precisione professionale. Come un ponteggio ben montato — robusto, sicuro, esatto. Il brand non urla: impone rispetto attraverso la chiarezza. Ogni elemento visivo è funzionale come un pennello da rifinitura.
Palette
NomeHexRuoloInchiostro#0F0F0DPrimario / TestoCalce#F5F2EBSfondoSegnale#E8521AAccento CTASalvia#6B8F71Accento SecondarioOttone#C8A84BAccento Premium
Tipografia
Titoli: "Unbounded" (weight 900, tracking -0.04em)
Drama: "Literata" Italic (weight 600)
Dati / Mono: "JetBrains Mono" (weight 700, color: Segnale)
Body: "Literata" Regular (18px, line-height 1.7)
Image Mood
Vernici e pigmenti ravvicinati, texture intonaco e calce, cemento grezzo, facciate prima/dopo, pennelli in dettaglio, cantiere notturno con luci di lavoro, rulli e attrezzatura professionale ordinata.
Pattern Hero Line



"[Verbo professionale] la tua" (Bold Sans, tracking stretto, colore Inchiostro al 25%)
"[Superficie]." (Massive Serif Italic, colore Calce, accent word in Segnale)
